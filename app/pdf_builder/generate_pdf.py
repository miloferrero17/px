...
def generate_recipe_pdf_from_data(
    ...
    wkhtmltopdf_path: str = "/opt/bin/wkhtmltopdf"  # Cambia este path si estás en local
) -> str:
    """
    Genera un PDF de la receta médica usando pdfkit (y wkhtmltopdf).
    """
    ...
    # 3) Configurar el path del ejecutable wkhtmltopdf
...
def generate_recipe_pdf(
    ...
    template_name: str = "receta.html",
    output_pdf: str = "receta.pdf",
    wkhtmltopdf_path: str = "/opt/bin/wkhtmltopdf"
) -> str:
    """
...
if __name__ == "__main__":
    ...
    generate_recipe_pdf_from_data(
        ...
        fecha=sample_fecha,
        output_pdf="app/temp/recet_eje.pdf",
        wkhtmltopdf_path="/opt/bin/wkhtmltopdf"  # Usá tu path local si no estás en Lambda
    )
