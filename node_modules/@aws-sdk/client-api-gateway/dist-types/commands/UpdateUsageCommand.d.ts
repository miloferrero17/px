...
declare const UpdateUsageCommand_base: {
    new (input: UpdateUsageCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUsageCommandInput, UpdateUsageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUsageCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUsageCommandInput, UpdateUsageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
