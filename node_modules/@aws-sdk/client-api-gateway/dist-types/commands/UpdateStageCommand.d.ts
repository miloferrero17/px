...
declare const UpdateStageCommand_base: {
    new (input: UpdateStageCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStageCommandInput, UpdateStageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateStageCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStageCommandInput, UpdateStageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
