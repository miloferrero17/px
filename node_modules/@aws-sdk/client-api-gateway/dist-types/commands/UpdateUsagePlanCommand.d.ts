...
declare const UpdateUsagePlanCommand_base: {
    new (input: UpdateUsagePlanCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUsagePlanCommandInput, UpdateUsagePlanCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUsagePlanCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUsagePlanCommandInput, UpdateUsagePlanCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
