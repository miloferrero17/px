...
declare const UpdateRequestValidatorCommand_base: {
    new (input: UpdateRequestValidatorCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRequestValidatorCommandInput, UpdateRequestValidatorCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRequestValidatorCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRequestValidatorCommandInput, UpdateRequestValidatorCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
